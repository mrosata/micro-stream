 ...
 */
import {
  docQueryHookEvent, inspect, id, isNot, isSomething, isObject, isFunction, getCopy, path
} from "./utils.js";
...
export default class Stream {
  ...
  map(fn) {
    ...
    if (this.__type !== STREAM) {
      let obs = new StreamObserver(this.cancel.bind(this), (data, index) => fn(__value(data)));
